...
namespace ModCaches.ExtendedDistributedCache.Tests.Lru;
...
public sealed class ConcurrentLruCacheSoakTests
{
  ...
  /// </summary>
  [Fact]
  public async Task WhenSoakConcurrentGetCacheEndsInConsistentStateAsync()
  {
    for (var i = 0; i < 10; i++)
    {
  ...
  [Fact]
  public async Task WhenSoakConcurrentGetWithArgCacheEndsInConsistentStateAsync()
  {
    for (var i = 0; i < 10; i++)
    {
      await Threaded.Run(4, () =>
  ...
  [Fact]
  public async Task WhenSoakConcurrentGetAndRemoveCacheEndsInConsistentStateAsync()
  {
    for (var i = 0; i < 10; i++)
    {
      await Threaded.Run(4, () =>
  ...
  [Fact]
  public async Task WhenSoakConcurrentGetAndRemoveKvpCacheEndsInConsistentStateAsync()
  {
    for (var i = 0; i < 10; i++)
    {
      await Threaded.Run(4, () =>
  ...
  [Fact]
  public async Task WhenSoakConcurrentGetAndUpdateCacheEndsInConsistentStateAsync()
  {
    for (var i = 0; i < 10; i++)
    {
      await Threaded.Run(4, () =>
  ...
  [Fact]
  public async Task WhenSoakConcurrentGetAndAddCacheEndsInConsistentStateAsync()
  {
    for (var i = 0; i < 10; i++)
    {
      await Threaded.Run(4, () =>
  ...
  [Fact]
  public async Task WhenSoakConcurrentGetAndUpdateValueTypeCacheEndsInConsistentStateAsync()
  {
  ...
  [Fact]
  public async Task WhenConcurrentUpdateAndRemoveKvpAsync()
  {
  ...
  [Theory]
  [Repeat(10)]
  public async Task WhenConcurrentGetAndClearCacheEndsInConsistentStateAsync(int iteration)
  {
    await Threaded.RunAsync(4, r =>
    {
      for (var i = 0; i < 10000; i++)
      {
  ...
  [Theory]
  [Repeat(10)]
  public async Task WhenConcurrentGetAndClearDuringWarmupCacheEndsInConsistentStateAsync(int iteration)
  {
    await Threaded.RunAsync(4, r =>
    {
      for (var i = 0; i < 10000; i++)
  ...
  [Theory]
  [Repeat(10)]
  public async Task WhenValueIsBigStructNoLiveLockAsync(int _)
  {
  ...
  private class Threaded
  {
    ...
    {
      return RunAsync(threadCount, i => action());
    }

    public static async Task RunAsync(int threadCount, Action<int> action)
    {
    ...
    {
      return RunAsync(threadCount, (Action<int>)(i => action()));
    }
